...
Canonical MPE2 Spread Communication Task task expressed in v4 evidence split form.
...
Gold method for mpe2_spread (v4_evidence_split): evidence-derived from fully specified reference.
