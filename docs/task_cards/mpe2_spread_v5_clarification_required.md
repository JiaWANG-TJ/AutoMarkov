...
task_description: "task requiring clarification of underspecified communication channels"
...
Canonical MPE2 Spread Communication Task task expressed in v5 clarification required form.
...
Gold method for mpe2_spread (v5_clarification_required): clarified specification resolving underspecified dynamics.
