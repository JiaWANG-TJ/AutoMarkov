...
task_description: "standard POSG task with canonical text ordering"
...
Canonical SMACv2 POSG battle task expressed in v1 canonical form.
...
Gold method for smacv2_posg (v1_canonical): fully specified POSG with known parameters.
