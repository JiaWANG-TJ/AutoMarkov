...
Canonical Navigation MiniGrid Environment task expressed in v4 evidence split form.
...
Gold method for nav_minigrid (v4_evidence_split): evidence-derived from fully specified reference.
