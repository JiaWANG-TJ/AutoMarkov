...
task_description: "reworded MDP control task preserving identical semantics"
...
Canonical Multi-Armed Bandit / CartPole task expressed in v2 paraphrased form.
...
Gold method for mab_cartpole (v2_paraphrased): fully specified MDP/POMDP with known parameters.
