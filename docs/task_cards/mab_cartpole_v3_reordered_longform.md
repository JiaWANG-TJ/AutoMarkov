...
Canonical Multi-Armed Bandit / CartPole task expressed in v3 reordered longform form.
...
Gold method for mab_cartpole (v3_reordered_longform): fully specified MDP/POMDP with known parameters.
