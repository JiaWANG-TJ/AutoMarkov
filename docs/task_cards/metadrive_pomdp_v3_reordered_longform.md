...
Canonical MetaDrive Partially Observable Driving task expressed in v3 reordered longform form.
...
Gold method for metadrive_pomdp (v3_reordered_longform): fully specified MDP/POMDP with known parameters.
