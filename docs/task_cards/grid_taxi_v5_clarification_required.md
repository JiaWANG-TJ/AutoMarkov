...
task_description: "task requiring clarification of underspecified reward shaping"
...
Canonical GridWorld Taxi Domain task expressed in v5 clarification required form.
...
Gold method for grid_taxi (v5_clarification_required): clarified specification resolving underspecified dynamics.
