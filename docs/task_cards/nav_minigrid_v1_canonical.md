...
task_description: "standard navigation task with canonical text ordering"
...
Canonical Navigation MiniGrid Environment task expressed in v1 canonical form.
...
Gold method for nav_minigrid (v1_canonical): fully specified MDP/POMDP with known parameters.
