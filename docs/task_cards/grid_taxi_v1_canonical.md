...
task_description: "standard taxi task with canonical text ordering"
...
Canonical GridWorld Taxi Domain task expressed in v1 canonical form.
...
Gold method for grid_taxi (v1_canonical): fully specified MDP/POMDP with known parameters.
