...
Canonical MPE2 Spread Communication Task task expressed in v3 reordered longform form.
...
Gold method for mpe2_spread (v3_reordered_longform): fully specified MDP/POMDP with known parameters.
