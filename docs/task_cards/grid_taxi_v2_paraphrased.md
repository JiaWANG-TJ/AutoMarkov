...
task_description: "reworded taxi task preserving identical semantics"
...
Canonical GridWorld Taxi Domain task expressed in v2 paraphrased form.
...
Gold method for grid_taxi (v2_paraphrased): fully specified MDP/POMDP with known parameters.
