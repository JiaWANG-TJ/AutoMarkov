...
Canonical SMACv2 POSG battle task expressed in v4 evidence split form.
...
Gold method for smacv2_posg (v4_evidence_split): fully specified POSG with known parameters.
