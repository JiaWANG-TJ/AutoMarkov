...
Canonical MetaDrive Partially Observable Driving task expressed in v4 evidence split form.
...
Gold method for metadrive_pomdp (v4_evidence_split): evidence-derived from fully specified reference.
