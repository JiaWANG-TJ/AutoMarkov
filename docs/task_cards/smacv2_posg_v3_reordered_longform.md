...
Canonical SMACv2 POSG battle task expressed in v3 reordered longform form.
...
Gold method for smacv2_posg (v3_reordered_longform): fully specified POSG with known parameters.
