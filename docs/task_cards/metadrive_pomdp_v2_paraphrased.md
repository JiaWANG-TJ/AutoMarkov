...
task_description: "reworded driving task preserving identical semantics"
...
Canonical MetaDrive Partially Observable Driving task expressed in v2 paraphrased form.
...
Gold method for metadrive_pomdp (v2_paraphrased): fully specified MDP/POMDP with known parameters.
