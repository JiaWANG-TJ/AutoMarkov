...
task_description: "standard driving task with canonical text ordering"
...
Canonical MetaDrive Partially Observable Driving task expressed in v1 canonical form.
...
Gold method for metadrive_pomdp (v1_canonical): fully specified MDP/POMDP with known parameters.
